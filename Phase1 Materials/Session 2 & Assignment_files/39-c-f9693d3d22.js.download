...
function f(n,t){var o=a(n),s=!o&&r(n),f=!o&&!s&&u(n),p=!o&&!s&&!f&&c(n),v=o||s||f||p,h=v?e(n.length,String):[],d=h.length
for(var b in n)!t&&!l.call(n,b)||v&&("length"==b||f&&("offset"==b||"parent"==b)||p&&("buffer"==b||"byteLength"==b||"byteOffset"==b)||i(b,d))||h.push(b)
return h}n.exports=f},c6wG:function(n,t,o){var e=o("dD9F"),r=o("sEf8"),a=o("mdPL")
var u=a&&a.isTypedArray
var i=u?r(u):e
n.exports=i},cClk:function(n,t,o){"use strict"
...
var u="[object Arguments]",i="[object Array]",c="[object Boolean]",s="[object Date]",l="[object Error]",f="[object Function]",p="[object Map]",v="[object Number]",h="[object Object]",d="[object RegExp]",b="[object Set]",g="[object String]",y="[object WeakMap]"
var w="[object ArrayBuffer]",O="[object DataView]",j="[object Float32Array]",m="[object Float64Array]",x="[object Int8Array]",A="[object Int16Array]",C="[object Int32Array]",T="[object Uint8Array]",_="[object Uint8ClampedArray]",k="[object Uint16Array]",S="[object Uint32Array]"
var F={}
F[j]=F[m]=F[x]=F[A]=F[C]=F[T]=F[_]=F[k]=F[S]=true
F[u]=F[i]=F[w]=F[c]=F[O]=F[s]=F[l]=F[f]=F[p]=F[v]=F[h]=F[d]=F[b]=F[g]=F[y]=false
...
var j=o("J2CL")
var m=o("oXx0")
var x,A,C,T,_,k,S,F,E,P,B,D,N,R
var I=(x=Object(m["a"])(),x(A=(T=C=function(n){Object(c["a"])(t,n)
function t(){Object(a["a"])(this,t)
return Object(u["a"])(this,Object(i["a"])(t).apply(this,arguments))}return t}(w["a"]),C.displayName="PopoverTrigger",T))||A)
var z=(_=Object(m["a"])(),_(k=(F=S=function(n){Object(c["a"])(t,n)
function t(){Object(a["a"])(this,t)
return Object(u["a"])(this,Object(i["a"])(t).apply(this,arguments))}return t}(w["a"]),S.displayName="PopoverContent",F))||k)
var G=(E=Object(O["a"])("7.0.0",null,"Use @instructure/ui-popover instead"),P=Object(m["a"])(),B=Object(d["a"])(),E(D=P(D=B(D=(R=N=function(n){Object(c["a"])(t,n)
function t(){var n
var o
Object(a["a"])(this,t)
...
var o=this.props,r=o.show,a=o.defaultShow,u=o.label,i=o.variant,c=o.alignArrow,s=o.trackPosition,f=o.onShow,p=o.onDismiss,v=o.onToggle,d=o.children,b=Object(e["a"])(o,["show","defaultShow","label","variant","alignArrow","trackPosition","onShow","onDismiss","onToggle","children"])
var g=w["a"].pick(t.Trigger,d)
var y=w["a"].pick(t.Content,d)
return l.a.createElement(h["a"],Object.assign({},b,{isShowingContent:r,defaultIsShowingContent:a,screenReaderLabel:u,color:"inverse"===i?"primary-inverse":"primary",shouldAlignArrow:c,shouldTrackPosition:s,onShowContent:function(){v(true)},onHideContent:function(n,t){var o=t.documentClick
p(n,o)
