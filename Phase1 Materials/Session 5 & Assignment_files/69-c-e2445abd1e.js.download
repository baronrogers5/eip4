(window["canvasWebpackJsonp"]=window["canvasWebpackJsonp"]||[]).push([[69],{"/HcR":function(e,n,r){"use strict"
var t=r("O92E")
var a=r("2bDf")
var i=r("IYu7")
var o=r("V3mB")
...
var P=(z=Object(j["a"])(),S=Object(U["j"])(C,T),z(G=S(G=(I=B=function(e){Object(s["a"])(n,e)
function n(){var e
Object(a["a"])(this,n)
...
return r}Object(o["a"])(n,[{key:"focus",value:function(){Object(x["a"])(this._link).focus()}},{key:"renderIcon",value:function(){var e=this.props.icon
this.props.display
return"function"===typeof this.props.icon?d.a.createElement("span",{className:T.icon},d.a.createElement(e,null)):e?d.a.createElement("span",{className:T.icon},e):null}},{key:"render",value:function(){var e,r=this
...
var x=(e={},Object(a["a"])(e,T.root,true),Object(a["a"])(e,T.inverse,"inverse"===s),Object(a["a"])(e,T["iconPlacement--".concat(v)],f&&this.hasVisibleChildren),Object(a["a"])(e,T.truncates,this.containsTruncateText),e)
var y=l&&"button"!==this.element?"button":null
var k="button"===this.element||"input"===this.element?"button":null
var _="button"!==y||o?null:"0"
var O=b["a"].omitViewProps(Object(w["a"])(this.props,n.propTypes),n)
var F=Object(t["a"])({},O,{elementRef:function(e){r._link=e
"function"===typeof m&&m(e)
"function"===typeof g&&g(e)},as:this.element,display:this.display,margin:h,className:p()(x),href:u,onClick:this.handleClick,"aria-disabled":o?"true":null,role:y,type:k,tabIndex:_})
return d.a.createElement(b["a"],F,f&&"start"===v&&this.renderIcon(),c,f&&"end"===v&&this.renderIcon())}},{key:"display",get:function(){if(this.props.display)return this.props.display
return this.props.icon?this.containsTruncateText?"flex":"inline-block":this.containsTruncateText?"block":"auto"}},{key:"hasVisibleChildren",get:function(){return Object(g["a"])(this.props.children)}},{key:"element",get:function(){return Object(O["a"])(n,this.props)}},{key:"focused",get:function(){return Object(y["a"])(this._link)}},{key:"focusable",get:function(){return Object(k["a"])(this._link)}},{key:"containsTruncateText",get:function(){var e=false
d.a.Children.forEach(this.props.children,(function(n){n&&Object(F["a"])(n,["TruncateText"])&&(e=true)}))
!e||this.props.display
return e}}])
n.displayName="Link"
return n}(u["Component"]),B.propTypes={href:f.a.string,children:f.a.node.isRequired,variant:f.a.oneOf(["default","inverse"]),linkRef:f.a.func,elementRef:f.a.func,as:f.a.elementType,disabled:f.a.bool,onClick:f.a.func,margin:m["c"].spacing,icon:f.a.oneOfType([f.a.func,f.a.element]),iconPlacement:f.a.oneOf(["start","end"]),display:f.a.oneOf(["auto","block","inline-block","flex","inline-flex"])},B.defaultProps={href:void 0,elementRef:void 0,disabled:false,onClick:void 0,margin:void 0,icon:void 0,display:void 0,variant:"default",as:void 0,linkRef:function(e){},iconPlacement:"start"},I))||G)||G)||G)},SLVX:function(e,n,r){"use strict"
...
//# sourceMappingURL=69-c-e2445abd1e.js.map